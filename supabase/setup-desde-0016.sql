-- =============================================================================
-- CRM OS · ACTUALIZACIÓN: migraciones 0016 en adelante (para un proyecto que YA tiene 0001 a 0015)
...
do $$ begin
  ...
  if to_regclass('public.tasks') is null and 16 > 10 then
  ...
  if exists (select 1 from information_schema.columns where table_schema = 'public' and table_name = 'channels' and column_name = 'connection_status') then
    raise exception 'Este proyecto YA tiene instalada la migración 0016 (existe la columna connection_status en channels). Si falta solo la 0017, usa setup-desde-0017.sql.';
  end if;
  if to_regclass('public.connection_events') is not null then
    raise exception 'Este proyecto YA tiene instalada la migración 0016 (existe la tabla connection_events). No ejecutes este archivo: avísame.';
  end if;
end $$;

-- ---------------- 20260919000016_connections.sql ----------------
-- =============================================================================
...
-- ---------------- 20260919000017_channels_multi.sql ----------------
-- =============================================================================
