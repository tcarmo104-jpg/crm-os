-- =============================================================================
-- CRM OS · ACTUALIZACIÓN: migraciones 0025 en adelante (para un proyecto que YA tiene 0001 a 0024)
...
do $$ begin
  ...
  if to_regclass('public.tasks') is null and 25 > 10 then
  ...
  if to_regclass('public.sequences') is not null then
    raise exception 'Este proyecto YA tiene instalada la migración 0025 (existe la tabla sequences). No ejecutes este archivo: avísame.';
  end if;
end $$;

-- ---------------- 20260919000025_sequences.sql ----------------
-- =============================================================================
