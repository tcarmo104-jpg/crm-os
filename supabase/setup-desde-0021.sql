-- =============================================================================
-- CRM OS · ACTUALIZACIÓN: migraciones 0021 en adelante (para un proyecto que YA tiene 0001 a 0020)
...
do $$ begin
  ...
  if to_regclass('public.tasks') is null and 21 > 10 then
  ...
  if to_regclass('public.webhook_stats') is not null then
    raise exception 'Este proyecto YA tiene instalada la migración 0021 (existe la tabla webhook_stats). No ejecutes este archivo: avísame.';
  end if;
end $$;
